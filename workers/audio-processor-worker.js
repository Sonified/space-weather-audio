...
self.onmessage = async (e) => {
    ...
    if (type === 'process-chunk') {
        ...
        console.log(`🏭 Worker processed chunk ${chunkIndex}: ${int32Samples.length.toLocaleString()} samples in ${totalTime.toFixed(0)}ms (decompress: ${decompressTime.toFixed(0)}ms)`);
