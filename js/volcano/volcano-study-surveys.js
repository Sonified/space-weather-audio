// ═══ VOLCANO STUDY ONLY — Survey submission for legacy volcano study workflow ═══
/**
 * volcano-study-surveys.js
 * Survey submission logic and Qualtrics submission pipeline.
 * Extracted from ui-surveys.js to isolate volcano study code from EMIC.
 */

import { submitCombinedSurveyResponse, getParticipantId } from './qualtrics-api.js';
import {
    saveSurveyResponse,
    getSessionResponses,
    getSessionState,
